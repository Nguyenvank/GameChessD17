...
public class AnalyzeInput extends JFrame {
	...
	public JButton bestMoveButton = new JButton("Đề xuất di chuyển");
	public JButton getEvalScore = new JButton("Nhận điểm đánh giá");
	...
	private JLabel fenTitle = new JLabel("phụ đề");
	private JLabel fenInputTitle = new JLabel("chèn mơi ");
	private JLabel uciCommandTitle = new JLabel("chọn chức năng ");
	...
	public void showCurrentFen(String fen) {
		...
		revalidate();
		System.out.println("được truy cập");
	}
