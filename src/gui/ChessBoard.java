...
public class ChessBoard extends JFrame {
	...
	public ChessBoard(boolean isMultiplayer, boolean isClient, String ip, int port, String title) {
		...
		JLabel text = new JLabel("Kết nối....");
	...
	public void squareClickedEvent(BoardSquare clickedSquare) {	
		...
		if (clickedSquare.hasChild()) {
			...
			if(highlightedSquare != null) {
				...
				//Fjern highlight hvis du trykker p� rute med highlight
	...
	//Fremhev ruten som har blitt trykket p�
	...
	//Nullstill fargene p� alle rutene
	...
	//Si ifra n�r en spiller har blitt tilkoblet
