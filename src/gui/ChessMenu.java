...
//Selve vinduet for sjakkmenyen som kommer p� oppstart. 
public class ChessMenu extends JFrame {
	...
	private JLabel ipAdressText = new JLabel("Nhập địa chỉ IP:");
	private JLabel addPortText1 = new JLabel("Nhâp Cổng");
	private JLabel lblNewLabel = new JLabel("");
	private JLabel addPortText2 = new JLabel("Vào cổng: ");
	...
	public ChessMenu() {		
		...
		JLabel welcomeText = new JLabel("Game Cờ Vua");
		...
		try {
			...
			JLabel lblOnlineFlerspiller = new JLabel("nhiều người kết nối trực tuyên");
		...
		//Legger til en focuslistener til tekstfeltet. N�r den mister fokus, s� blir informasjonen i feltet sendt videre. 
		...
		//Focuslistener for porten til join. Gj�r det samme som den over. 
		...
		//Focuslistener for porten til host. Gj�r det samme som de to over. 
		...
		//Lukker vinduet n�r du lukker vinduet. 
